...
export default function Home() {
  ...
  const votedCount = poll?.votedOptionIds.length ?? 0;
  const canCreate = !!me && !poll?.myOptionId && votedCount < 2;
  const hasVotedAll = votedCount >= 2;
      ...
      <div className="max-w-2xl mx-auto space-y-4 md:space-y-6">
        ...
        <div className="pixel-card p-4 md:p-6 flex items-center justify-between">
          ...
          {me ? (
            ...
            <a
              ...
              className="pixel-btn flex items-center gap-2 text-sm"
            >
        ...
        {canCreate && (
          <form onSubmit={handleCreate} className="pixel-card p-4 md:p-6">
            ...
            <p className="text-[#8b8680] text-xs font-mono mb-4">每人限投两票，提交即算投出一票</p>
